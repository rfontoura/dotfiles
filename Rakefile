...
def install_homebrew
  ...
  puts "======================================================"
  run %{brew install zsh ctags git hub tmux reattach-to-user-namespace the_silver_searcher ghi hub diff-so-fancy tidy-html5 git-extras}
...
>>>>>>> 996915dc227ecc30ebbac8b0e003ca4993799297
      end
    end
